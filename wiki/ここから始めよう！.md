...
7. exo/alias(.object)が提供する***タイムライン*で動画と音声ファイルを選択**

> [!WARNING]
> この手順では、*タイムライン*内の動画要素に[Unmult](https://github.com/mes51/AVIUtl2_Unmult)を使用します。これにより、すべての黒ピクセルが透明ピクセルに変換され、正確なMV効果が得られます。**これは「合成モード」を選択することとは異なり、同じ効果は得られません！！**
